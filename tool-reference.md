...
| `spreadsheet_write_styles` | no | Bulk overwrite cell styles in a rectangular block (offset-based; Office >= 3.7.0) |
...
| `spreadsheet_delete_file` | **yes** | Permanently delete an ENTIRE spreadsheet file (.osheet); evicts local name cache; Office >= 3.7.0 |
